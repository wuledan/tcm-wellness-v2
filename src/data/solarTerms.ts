...
export const solarTerms: SolarTerm[] = [
  ...
  { id: 2, name_zh: "雨水", name_en: "Rain Water", date: "Feb 18", description: "Increased rainfall and humidity. Dampness begins to rise.", dietary_tip: "Eat foods that resolve dampness:薏米 (coix seed), winter melon, and red beans.", lifestyle_tip: "Avoid damp environments. Keep feet dry and warm." },
  { id: 3, name_zh: "惊蛰", name_en: "Awakening of Insects", date: "Mar 5", description: "Temperatures rise and thunder begins. All life awakens.", dietary_tip: "Eat light, cooling foods. Pear is excellent for moistening the lungs.", lifestyle_tip: "Increase outdoor activities. Stretch and move more." },
  { id: 4, name_zh: "春分", name_en: "Spring Equinox", date: "Mar 20", description: "Day and night are equal. Balance of Yin and Yang.", dietary_tip: "Balance cooling and warming foods. Avoid extremes.", lifestyle_tip: "Maintain a regular schedule. Meditate to find inner balance." },
  ...
  { id: 7, name_zh: "立夏", name_en: "Start of Summer", date: "May 5", description: "Summer begins. Heat starts to build.", dietary_tip: "Eat lighter, cooling foods. Increase vegetable intake.", lifestyle_tip: "Wake up earlier. Avoid midday heat exposure." },
  ...
  { id: 9, name_zh: "芒种", name_en: "Grain in Ear", date: "Jun 5", description: "Wheat ripens. Hot and humid weather begins.", dietary_tip: "Eat light, cooling foods. Mung bean soup is excellent.", lifestyle_tip: "Take short naps. Bathe regularly to feel refreshed." },
  ...
  { id: 12, name_zh: "大暑", name_en: "Major Heat", date: "Jul 22", description: "The hottest time of the year.", dietary_tip: "Eat light, easily digestible foods. Avoid greasy and spicy.", lifestyle_tip: "Avoid strenuous outdoor activities during peak heat." },
  ...
  { id: 15, name_zh: "白露", name_en: "White Dew", date: "Sep 7", description: "Temperatures drop. Dew forms at night.", dietary_tip: "Eat warm, nourishing foods. Avoid raw and cold foods.", lifestyle_tip: "Cover the body at night. Protect the neck from cold." },
  { id: 16, name_zh: "秋分", name_en: "Autumn Equinox", date: "Sep 22", description: "Day and night equal again. Yin and Yang balanced.", dietary_tip: "Balance your diet. Eat seasonal autumn vegetables.", lifestyle_tip: "Practice moderation in all activities." },
  ...
  { id: 22, name_zh: "冬至", name_en: "Winter Solstice", date: "Dec 21", description: "Shortest day. Yin at its peak, Yang begins to rise.", dietary_tip: "Eat warming foods to nourish the newly born Yang.", lifestyle_tip: "Rest deeply. It's the most important day for rejuvenation." },
  { id: 23, name_zh: "小寒", name_en: "Minor Cold", date: "Jan 5", description: "Severe cold but not yet the coldest.", dietary_tip: "Eat warming, kidney-nourishing foods: black beans, walnuts.", lifestyle_tip: "Keep extremities warm. Avoid cold exposure." },
