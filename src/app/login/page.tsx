        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2.5 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-400 text-gray-800"
            />
            <p className="text-xs text-gray-400 mt-1">Use any email to sign in (MVP demo)</p>
          </div>
          <button
            type="submit"
    ...
    <div className="min-h-[calc(100vh-4rem)] bg-gradient-to-b from-emerald-50 via-white to-white flex items-center">
      <div className="max-w-md mx-auto px-4 w-full">
        <div className="text-center mb-8">
          ...
          <h1 className="font-serif text-3xl font-bold text-gray-900 mb-2">Welcome</h1>
          <p className="text-gray-500">Sign in to access your personalized wellness dashboard</p>
        </div>
